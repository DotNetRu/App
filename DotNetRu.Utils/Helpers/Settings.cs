...
namespace XamarinEvolve.Clients.Portable
{
  ...
  public class Settings : INotifyPropertyChanged
  {
    ...
    public DateTime LastFavoriteTime
    {
      ...
      set { AppSettings.AddOrUpdateValue<DateTime>(LastFavoriteTimeKey, value); }
    }
    ...
    public bool HasSetReminder
    {
      ...
      set { AppSettings.AddOrUpdateValue<bool>(HasSetReminderKey, value); }
    }
    ...
    public bool GooglePlayChecked
    {
      ...
      set { AppSettings.AddOrUpdateValue<bool>(GooglePlayCheckedKey, value); }
    }
    ...
    public bool AttemptedPush
    {
      ...
      set { AppSettings.AddOrUpdateValue<bool>(AttemptedPushKey, value); }
    }
    ...
    public bool PushRegistered
    {
      ...
      set { AppSettings.AddOrUpdateValue<bool>(PushRegisteredKey, value); }
    }
    ...
    public bool NeedsSync
    {
      get
      {
        return AppSettings.GetValueOrDefault<bool>(NeedsSyncKey, NeedsSyncDefault) ||
    ...
    {
      get { return AppSettings.GetValueOrDefault<int>(LoginAttemptsKey, LoginAttemptsDefault); }
      set { AppSettings.AddOrUpdateValue<int>(LoginAttemptsKey, value); }
    }
    ...
    {
      get { return AppSettings.GetValueOrDefault<DateTime>(LastSyncKey, LastSyncDefault); }
      set
      {
