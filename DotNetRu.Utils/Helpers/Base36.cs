...
namespace XamarinEvolve.Utils.Base36
{
	...
	public struct Base36
	{
		...
		public string Value
		{
			get => NumberToBase36(this.numericValue);

		    set
			{
				try
				{
				    this.numericValue = Base36ToNumber(value);
				}
				catch
				{
		...
		{
			return NumberToBase36(this.numericValue);
		}
		...
		{
			string base36Value = NumberToBase36(this.numericValue);
